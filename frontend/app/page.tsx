      ...
      <div className="max-w-[1400px] mx-auto px-6">
        ...
        {loading ? (
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {pacotes.map((pacote, i) => (
                <AnimatedSection key={pacote.id} animation="fade-up" delay={i * 120}>
                  {/* O Card do pacote continua levando para os detalhes daquele pacote específico */}
            ...
            <AnimatedSection animation="fade-up" delay={200} className="mt-10">
              {/* O botão "Ver todos" agora redireciona para a lista de Agências */}
      ...
      >
        ...
        <div className="mx-auto flex max-w-[1400px] items-center justify-between px-6 py-4">
          ...
          <nav className="hidden lg:flex items-center gap-8">
            {/* Guias do Menu substituídas para apontar para Agências em vez de Pacotes */}
            {['Hoteis', 'Agencias', 'Atracoes', 'Passeios', 'Biodiversidade', 'Gastronomia', 'Comunidades', 'Informacoes', 'Parceiros'].map(item => (
        ...
        {isMobileMenuOpen && (
          <div className="absolute top-full left-0 w-full bg-white border-b border-slate-200 p-6 flex flex-col gap-4 shadow-2xl lg:hidden z-50">
            {/* Guias Mobile substituídas para apontar para Agências em vez de Pacotes */}
            {['Hoteis', 'Agencias', 'Atracoes', 'Passeios', 'Aldeias', 'Biodiversidade', 'Informacoes', 'Parceiros'].map(item => (
              <Link key={item} href={`/${item.toLowerCase()}`}
