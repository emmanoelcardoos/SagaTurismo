          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-16 mb-12 md:mb-16">
            <div className="space-y-5 md:col-span-1">
              ...
              <div className="flex gap-3 pt-1">
                <a href="#" className="w-9 h-9 bg-white/10 hover:bg-[#F9C400] hover:text-[#00577C] rounded-lg flex items-center justify-center transition-all text-white/60"><Share2 size={15} /></a>
                <a href="#" className="w-9 h-9 bg-white/10 hover:bg-[#F9C400] hover:text-[#00577C] rounded-lg flex items-center justify-center transition-all text-white/60"><Globe2 size={15} /></a>
              </div>
            </div>
