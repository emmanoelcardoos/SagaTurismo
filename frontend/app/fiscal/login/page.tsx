    ...
    <div className="min-h-screen flex items-center justify-center bg-stone-900 px-4">
      <div className="w-full max-w-sm bg-white rounded-3xl p-8 shadow-2xl">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            <div className="relative">
              ...
              <input 
                ...
                className="w-full bg-stone-50 border border-stone-200 rounded-xl py-4 pl-12 pr-4 font-medium text-stone-700 outline-none focus:border-[#00577C] focus:ring-2 focus:ring-[#00577C]/20 transition-all"
                required
              />
            </div>
          </div>
          ...
          <button 
            type="submit"
            className="w-full bg-[#00577C] text-white py-4 rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-[#004a6b] transition-all active:scale-95"
          >
