...
// ── HOOK DE ANIMAÇÃO DE SCROLL (NATIVO E LEVE) ──
    ...
    const observer = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting) {
          setIsVisible(true);
          // Opcional: Se quiseres que a animação aconteça só uma vez, descomenta a linha abaixo
...
function AnimatedSection({ 
  ...
  return (
    <div 
      ref={ref} 
      className={`${baseClass} ${isVisible ? "opacity-100 translate-y-0 translate-x-0 scale-100" : hiddenClass} ${className}`}
    ...
    <main className={`${jakarta.className} min-h-screen bg-[#FDFCF7] text-slate-900 overflow-x-hidden`}>
          ...
          <div className="mx-auto max-w-7xl relative z-10">
            ...
            <div className="flex items-start gap-0 overflow-x-auto pb-4 scrollbar-hide">
              {[
                ...
                <div key={i} className="flex items-start min-w-[220px] md:min-w-0 md:flex-1 group">
                  <div className="flex flex-col items-center">
                    <div className="w-12 h-12 rounded-full bg-[#F9C400] flex items-center justify-center shadow-lg flex-shrink-0 z-10 group-hover:scale-110 transition-transform">
      ...
      <section id="origens" className="relative py-28 px-5 bg-[#FDFCF7] overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl grid lg:grid-cols-2 gap-20 items-center relative z-10">
            ...
            <div className="flex gap-4 pt-4">
              {[
                ...
                <div key={label} className="flex flex-col items-center gap-2">
                  <div className={`w-12 h-12 ${color} rounded-2xl flex items-center justify-center shadow-lg hover:-translate-y-2 transition-transform`}>
          ...
          <AnimatedSection animation="fade-left" className="grid grid-cols-2 gap-5 relative">
      ...
      <section className="relative py-28 px-5 bg-[#001f3f] text-white overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl relative z-10">
          <AnimatedSection animation="fade-up" className="text-center mb-20 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 items-start">
            ...
            <AnimatedSection animation="fade-up" delay={200} className="relative p-8 rounded-[2rem] border border-[#F9C400]/20 bg-gradient-to-b from-[#F9C400]/10 to-transparent overflow-hidden group hover:-translate-y-2 transition-transform">
            ...
            <AnimatedSection animation="fade-left" delay={400} className="md:mt-10">
              {loading ? <div className="h-72 bg-white/5 rounded-2xl animate-pulse" />
                : fotosGuerrilha[1]
      ...
      {/* ───── SECÇÃO 3: EMANCIPAÇÃO + ARQUEOLOGIA ───── */}
      <section className="py-24 px-5 bg-[#FDFCF7] relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center mb-24">
            <AnimatedSection animation="zoom-in" className="relative">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <AnimatedSection key={card.title} animation="fade-up" delay={idx * 200}>
                <div className={`relative p-8 rounded-[2rem] bg-gradient-to-br ${card.color} text-white overflow-hidden group hover:scale-[1.02] transition-transform duration-300 shadow-2xl h-full`}>
      ...
      <section className="relative py-32 px-5 overflow-hidden">
        ...
        <AnimatedSection animation="zoom-in" className="relative z-10 mx-auto max-w-5xl text-center">
