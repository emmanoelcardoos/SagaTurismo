...
import { ArrowLeft, Menu, X, Compass, MapPin } from 'lucide-react';
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
            ...
            <div className="flex flex-col gap-6 md:gap-10">
              ...
              <p className={`${inter.className} text-white/60 md:text-white/50 text-base md:text-lg leading-relaxed max-w-md`}>
                Estamos organizando uma agenda completa de passeios bate e volta pelas trilhas, rios e cachoeiras de São Geraldo do Araguaia. Prepare-se para explorar a nossa natureza com guias locais especializados.
              </p>
