              ...
              <form onSubmit={handlePagamento} className="space-y-6 md:space-y-8">
                ...
                <SectionCard className="p-6 md:p-10 text-left">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-8">
                    ...
                    <button type="button" onClick={() => setMetodoPagamento('cartao')} className={`flex flex-col items-center justify-center gap-3 p-5 rounded-2xl border-2 transition-all ${metodoPagamento === 'cartao' ? 'border-[#0085FF] bg-blue-50/50 text-[#0085FF]' : 'border-slate-100 bg-slate-50 text-slate-400'}`}>
