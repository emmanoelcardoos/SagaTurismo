...
export default function HomePage() {
  ...
  useEffect(() => {
    async function fetchHeroImages() {
      const { data, error } = await supabase
        .from('galeria')
        .select('id, imagem_url, titulo')
        .limit(5); // Limitar a 5 fotos para a performance
  ...
  // Intervalo de 15 segundos para a troca de imagens
  useEffect(() => {
  ...
  // Fallback seguro caso a base de dados ainda não tenha imagens
      ...
      <section className="relative min-h-screen overflow-hidden pt-20 bg-slate-900">
        ...
        <div className="relative z-10 mx-auto flex min-h-[calc(100vh-80px)] max-w-7xl items-center px-5 py-24">
          <div className="max-w-3xl text-white">
            ...
            {/* O Título e Subtítulo baseiam-se na lista (ou fallback) correspondente à imagem atual */}
