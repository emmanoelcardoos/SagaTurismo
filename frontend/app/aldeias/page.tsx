...
import { Loader2, MapPin, ArrowRight, ChevronDown, Menu, X, ShieldCheck } from 'lucide-react';
...
export default function AldeiasPage() {
  ...
  return (
    <main className={`${inter.className} min-h-screen flex flex-col bg-[#FAFAF7] text-slate-900`}>
