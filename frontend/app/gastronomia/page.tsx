...
export default function GastronomiaPage() {
  ...
  return (
    <main className={`${inter.className} bg-white text-slate-900 overflow-x-hidden min-h-screen`}>
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center pt-28 pb-16 md:pt-32 md:pb-24 overflow-hidden bg-[#002f40]">
        <div className="absolute inset-0 z-0 pointer-events-none">
          <video 
            ...
            muted 
            playsInline
            className="absolute inset-0 w-full h-70 object-cover opacity-80" 
            />
