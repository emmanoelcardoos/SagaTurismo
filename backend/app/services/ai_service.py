...
def validar_endereco_com_ia(imagem_bytes: bytes, lista_nomes: list, mime_type: str = "image/jpeg") -> dict:
    ...
    "3. RESIDENTES (13 a 59 anos): Exige OBRIGATORIAMENTE um Comprovante de Residência OU um Título de Eleitor. O documento DEVE registrar o município de 'São Geraldo do Araguaia - PA' (ou 'Covilhã' para fins de teste). RG ou CNH sozinhos NÃO SÃO ACEITOS para esta faixa etária.\n"
    ...
    "- FRAUDE DETECTADA: Se a idade calculada for entre 13 e 59 anos, e a pessoa não pertencer a categorias especiais (PCD, Militar, Professor), REJEITE IMEDIATAMENTE caso o documento anexado seja apenas identidade (RG/CNH) SEM o acompanhamento de um comprovante de morada ou Título de Eleitor válido.\n\n"
    ...
    "  },\n"
    "  \"motivo\": \"Explique em uma frase curta qual regra do decreto foi aplicada. Se for rejeitado por idade incorreta, cite a idade calculada e a falta de comprovante de morada ou título de eleitor.\"\n"
    "}\n"
)
