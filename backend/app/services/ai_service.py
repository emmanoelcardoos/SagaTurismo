...
def validar_endereco_com_ia(imagem_bytes: bytes, lista_nomes: list, mime_type: str = "image/jpeg") -> dict:
    try:
        ...
        prompt = (
            ...
            "Veja se no documento apresentado há explicitamente o nome de São Geraldo do Araguaia ou Covilhã - Portugal, ou alguma referência clara aos municípios. Aceite qualquer documento que possuirem os nomes dessas cidades \n\n"
